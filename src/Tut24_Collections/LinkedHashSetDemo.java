...
public class LinkedHashSetDemo {
    public static void main(String[] args) {
        // all methods are same as hash set
        // duplicates not allowed as hashset
        // insertion order is preserved unlike hashset
        // initial size is 16, load factor 0.75


        //Declarations
        LinkedHashSet mySet = new LinkedHashSet();
//        LinkedHashSet <String> myStringSet = new LinkedHashSet<String>();
//        LinkedHashSet <Integer> myIntSet = new LinkedHashSet<Integer>();
//        Set mySet = new HashSet();
        ...
        System.out.println(mySet.getLast());

        System.out.println(mySet.reversed());
